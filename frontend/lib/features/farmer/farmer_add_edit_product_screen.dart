...
class _FarmerAddEditProductScreenState extends ConsumerState<FarmerAddEditProductScreen> {
  ...
  Future<void> _pickProductImage() async {
    ...
    if (pickedFile != null) {
      ...
      showAppSnackBar(context, 'Image uploaded successfully!', type: SnackBarType.success);
    }
  }
  ...
  Future<void> _saveProduct() async {
    ...
    final product = ProductModel(
      ...
      image: _imageController.text.trim().isNotEmpty
          ...
          : suggestImage(_nameController.text.trim()),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Auto-suggested from produce name or upload custom image', style: GoogleFonts.plusJakartaSans(fontSize: 11, color: const Color(0xFF647C72))),
                      const SizedBox(height: 10),
                      Row(
                        children: [
                          OutlinedButton.icon(
                            onPressed: _pickProductImage,
                            icon: const Icon(Icons.photo_camera, size: 16, color: Color(0xFF2E7D32)),
                            label: Text('Choose File', style: GoogleFonts.plusJakartaSans(color: const Color(0xFF2E7D32), fontWeight: FontWeight.bold, fontSize: 12)),
